...
```{r}
#### @Frankie, can u add a regression plan: "Few sentence intro to plan for multiple regression, variables used, process, etc." 
### also add  "Discussion of R-squared, parameter direction and significance. Discussion of criteria used to choose final model" after the model

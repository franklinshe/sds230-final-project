...
```{r}
# interaction plots 
interaction.plot(Walc2, school, grade, type = 'b', lwd = 3, col = c('red','blue','black'), main = "Interaction Plot of Walc and School")
...
*An interaction plot of school and Walc does not indicate a strong interaction. An interaction plot of sex and plot does indicate an interaction between these variables on grade.*

```{r}
# Bartlett and Levene Test??? im guessing not needed
...
# Regression model with indicators and without intercept.

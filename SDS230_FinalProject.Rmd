...
```{r}
# GitHub Repository - https://github.com/franklinshe/sds230-final-project

local changes here. :D
# Packages
library(plyr)
...
transdata$logWalc <- log(transdata$Walc)
transdata$logDalc <- log(transdata$Dalc)
transdata$logabs <- log(transdata$absences)

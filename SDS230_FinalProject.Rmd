...
```{r}
hist(grade, main = "Histogram of Grades", xlab = "Grade (0 - 20)", xlim = c(0, 20), col = 3)
# grade is pretty much the only variable that is normally distributed.. is this an issue?
boxplot(grade ~ school, main = "Boxplot of Grades by School", ylab = "Grade (0 - 20)")
boxplot(grade ~ sex, main = "Boxplot of Grades by Gender", ylab = "Grade (0 - 20)")
```
